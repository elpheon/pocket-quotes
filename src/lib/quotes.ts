...
const SAMPLE_QUOTES: Quote[] = [
  { id: '1', text: "I'm not arguing, I'm just explaining why I'm right.", author: 'Anonymous', tags: ['savage', 'funny'] },
  { id: '2', text: "My wallet is like an onion. Opening it makes me cry.", author: 'Unknown', tags: ['money', 'relatable'] },
  { id: '3', text: "I'm on a seafood diet. I see food and I eat it.", author: 'Anonymous', tags: ['food', 'funny'] },
  { id: '4', text: "I don't need anger management. You need to stop making me mad.", author: 'Unknown', tags: ['savage'] },
  { id: '5', text: "Common sense is like deodorant. People who need it most never use it.", author: 'Anonymous', tags: ['savage', 'truth'] },
  { id: '6', text: "My bed is a magical place where I suddenly remember everything I forgot to do.", author: 'Unknown', tags: ['relatable', 'funny'] },
  { id: '7', text: "I'm not lazy. I'm just on energy-saving mode.", author: 'Anonymous', tags: ['lazy', 'funny'] },
  { id: '8', text: "Silence is golden. Unless you have kids. Then silence is suspicious.", author: 'Unknown', tags: ['parenting', 'truth'] },
  { id: '9', text: "I followed my heart and it led me to the fridge.", author: 'Anonymous', tags: ['food', 'relatable'] },
  { id: '10', text: "I'm not short. I'm concentrated awesome.", author: 'Unknown', tags: ['savage', 'funny'] },
  { id: '11', text: "Some days I amaze myself. Other days I look for my phone while holding it.", author: 'Anonymous', tags: ['relatable', 'funny'] },
